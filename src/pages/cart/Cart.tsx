...
export default function Cart() {
  const [extendedPurchases, setExtendededPurchases] = useState<ExtendedPurchase[]>([])
            ...
            {extendedPurchases.length > 0 && (
              <div className='my-3 rounded-sm bg-white p-5 shadow'>
                {extendedPurchases.map((purchase, index) => (
                  <div
                    key={purchase._id}
                    className='mb-5 grid grid-cols-12 items-center rounded-sm border border-gray-200 bg-white py-5 px-4 text-center text-sm text-gray-500 first:mb-0'
                  >
                    <div className='col-span-6'>
                      <div className='flex'>
                        <div className='flex flex-shrink-0 items-center justify-center pr-3'>
        ...
        <div className='sticky bottom-0 z-10 flex flex-col items-center rounded-sm border-gray-100 bg-white p-5 shadow sm:flex-row'>
          ...
          <div className='ml-auto flex items-center'>
            ...
            <Button
              ...
              className='ml-4 flex h-10 w-52 items-center justify-center bg-red-500 text-center text-sm uppercase text-white hover:bg-red-600'
            >
              Mua hàng
            </Button>
          </div>
