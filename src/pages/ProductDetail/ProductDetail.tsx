...
export default function ProductDetail() {
  ...
  const handleZoom = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    // Cách 2: lấy offsetX, offsetY khi chúng ta ko xử lý được bubble event
    // const offsetX = event.pageX - (rect.x + window.scrollX)
    // const offsetY = event.pageY - (rect.x + window.scrollY)
  ...
  const next = () => {
    console.log((product as ProductType).images.length)
          ...
          <div className='grid grid-cols-12 gap-9'>
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                <div className='textgray-500 line-through'>₫{formatCurrency(product.price_before_discount)}</div>
