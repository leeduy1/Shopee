...
export default function Header() {
  ...
  // (tất nhiên trừ trường hợp logout rồi nhảy sang RegisterLayout rồi nhảy vào lại)
                  ...
                  {purchasesInCart ? (
                    <div className='p-2'>
                      ...
                      <div className='mt-6 flex items-center justify-between'>
                        ...
                        <Link to={path.cart} className='bg-orange px-4 py-2 capitalize text-white hover:bg-opacity-90'>
                          Xem giỏ hàng
                        </Link>
                      </div>
                    </div>
